...
import { ReadMarketsActionContent, ReadMarketsData, ReadMarketsActionParams, PolymarketMarket,
  PolymarketApiResponse,
  PolymarketApiDataSchema,
  PolymarketRawMarket,
  PolymarketRawMarketSchema,
  PolymarketApiCallParams,
  PolymarketSingleMarketApiResponse} from "../types";
      ...
      handler: async (
        ...
        _responses: Memory[],
            ...
            try {
                ...
                const response = formatMarketsResponse(filteredMarkets, query);
